...
#             objects have:
#               Radius, Centerpoint,color
#
#
#     f. What does a RoseWindow RENDER method do?
#            Initially renders the window in question.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It indicates to the program that the user is finished. any other closure
#            might be an error.
#
